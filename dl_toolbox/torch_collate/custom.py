...
class CustomCollate(): # call in inria_ds batch_aug = no
    ...
    def __call__(self, batch, *args, **kwargs):
        ...
        keys_to_collate = ['image', 'orig_image','id', 'mask', 'orig_mask', 'name', 'proportions', 'downscaled_mask'] # liste des autres element  tensor qui sont envoyé au default collate
