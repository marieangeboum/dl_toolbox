...
<<<<<<< HEAD
                ...
                # orig_img_grid = torchvision.utils.make_grid(orig_img[start:end, :3, :, :], padding=10, normalize=True)
                ...
                # print(orig_img_grid.shape)
                grids = [img_grid, mask_grid, heat_maps_grid,error_grid, out_grid]
=======
