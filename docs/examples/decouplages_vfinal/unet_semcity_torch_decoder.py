...
def main():     
    ...
    parser.add_argument('--model_path', type = str, default ="smp_unet_{}_{}_D_ft_{}")
    ...
    model_result_viz = (args.model_path+"_result_viz").format(args.data_source, args.data_target)   
